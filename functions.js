...
let containerSort=document.querySelector(".container-sort");
  ...
  let btnAddNewCar = document.querySelector(".new-car");

  btnAddNewCar.addEventListener("click", (e) => {
    attachNewCarPage();
  });
...
function update() {
  let inp1 = document.getElementById("culoareInp");
  let inp2 = document.getElementById("marcaInp");
  let inp3 = document.getElementById("modelInp");
  let inp4 = document.getElementById("nrDeLocuriInp");
  let inp5 = document.getElementById("pretInp");
...
async function attachUpdatePage(car) {
  ...
  container.innerHTML = ` <h1>Update car</h1> 
        ...
        <p>
            <label for="modeInpl">Model</label>
            <input name="modelInp" type="text" class="model" id="model" value="${car.model}">
        </p>
        <p>
            <label for="culoareInp">Culoare</label>
            <input name="culoareInp" type="text"  class="culoare" id="culoare" value="${car.culoare}">
        </p>
        <p>
            <label for="nrDeLocuriInp">Numar de locuri</label>
            <input name="nrDeLocuriInp" type="text" class="nrDeLocuri" id="nrDeLocuri" value="${car.nrDeLocuri}">
        </p>
        <p>
            <label for="pretInp">Pret</label>
            <input name="pretInp" type="text" class="pret" id="pret" value="${car.pret}">
        </p>
        <div>
  ...
  container.innerHTML = `
    ...
    <ul class="error">
        ...
        <p>
            ...
            <input name="brDeLocuri" type="text"  class="nrDeLocuri" id="nrDeLocuri">
        </p>
